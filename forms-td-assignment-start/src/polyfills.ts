...
// decorators), you can remove. import 'core-js/es7/reflect';
...
// patch requestAnimationFrame (window as any).__Zone_disable_on_property =
// true; // disable patch onProperty such as onclick (window as
// any).__zone_symbol__BLACK_LISTED_EVENTS = ['scroll', 'mousemove']; //
